      ...
      <div className="">
        ...
        <div className="flex md:flex-row flex-col gap-4">
                ...
                <div className="flex justify-between">
                  <div className="flex items-center gap-2">
                    <input
                      type="checkbox"
                      id="receiveEmail"
                      className="w-4 h-4 text-primary border-gray-300 rounded focus:ring-[#1ABC9C]"
                    />
                    <label
          ...
          <div className="md:w-[35%]">
            <div className="">
              <h2 className="text-primary text-2xl mb-3">Contact</h2>
              <div className="w-[80px] h-[2px] mb-6 bg-secondary"></div>
            </div>
            ...
            <div className="flex items-center gap-4 mt-4">
              <FaFacebookF className="text-2xl text-black/80 cursor-pointer hover:text-primary" />
              <FaTwitter className="text-2xl text-black/80 cursor-pointer hover:text-primary" />
              <FaLinkedinIn className="text-2xl text-black/80 cursor-pointer hover:text-primary" />
              <FaYoutube className="text-2xl text-black/80 cursor-pointer hover:text-primary" />
            </div>
          </div>
        </div>
      </div>

    ...
    <div className="pb-20 pt-14 my-14  md:my-28 px-4 bg-[#FFFAF9]">
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 lg:grid-cols-4 w-[90%]  mx-auto gap-6">
        {services.map((service, index) => (
          <div
            key={index}
            className="hover:-translate-y-[12px] transition-all duration-700 hover:bg-gradient-to-t from-[#FD9678]  p-[0.8px] hover:shadow-2xl shadow-md rounded-lg hover:rounded-t-lg hover:rounded-none hover:text-secondary"
          >

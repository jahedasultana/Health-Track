...
const TopDoctors = () => {
    return (
        <div className="grid md:grid-cols-3 grid-cols-1 w-[90%] mx-auto">
            <div className="p-10 bg-gradient-to-r from-primary to-primary/60 text-white space-y-4">
           ...
           <Button buttonText={'Read More'}/>
            ...
            <div className="p-10 bg-gradient-to-r from-primary/90 to-primary/65 text-white space-y-4">
                <h2 className="text-[25px]">24 Hours Service</h2>
            <p>Cum sociis natoque penatibus et magnis dis parturient montesmus. Pro vel nibh et elit mollis commodo et nec augue tristique sed volutpat.</p>
            <Button buttonText={'Read More'}/>
            </div>
            <div className="p-10 bg-gradient-to-r from-primary to-primary/75 text-white space-y-4">

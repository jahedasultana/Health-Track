    ...
    <section
      ...
      <div className="container mx-auto text-center p-5 md:p-0 lg:pb-5">
        ...
        <div className="text-center pb-2">
          ...
          <h2 className="relative text-[#1ABC9C] md:text-4xl text-2xl font-bold mb-3 w-[max-content] mx-auto">
        ...
        <form
          ...
          className="flex justify-center gap-5 ">
            <input
              className="input px-3 rounded-sm py-2  border focus:outline-none shadow-md"
              type="email"
              required

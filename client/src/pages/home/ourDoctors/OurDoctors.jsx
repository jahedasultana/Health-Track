    ...
    <section className="w-[90%] mx-auto">
      ...
      <div className="w-full max-w-xs bg-white rounded-lg shadow-lg ">
        ...
        <div className="overflow-hidden relative group">
            <img className="group-hover:scale-105 transition-all duration-700" src="https://images.unsplash.com/photo-1542156822-6924d1a71ace?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" alt="" />

        ...
        <div className="w-[40%] flex items-end rounded-md">
          <div className="relative w-full flex items-end rounded-md group overflow-hidden">
            ...
            <div className="absolute inset-0 flex flex-col justify-center bg-black bg-opacity-20  items-center text-white z-10">
              <h2 className="text-3xl text-[#eef0f4] font-semibold">Doctor Appointment</h2>
              <h3 className="text-xl text-[#eef0f4] font-semibold">Total Doctor: 101</h3>
              <h5 className="text-lg text-[#eef0f4] font-semibold">category: 10</h5>
              <button className="mt-4 px-4 py-2 bg-[#1DBFCC] rounded-md hover:bg-[#08d7e6]">
                Learn More
              </button>
            </div>
        ...
        <div className="w-[40%] flex items-end rounded-md">
          <div className="relative w-full flex items-end rounded-md group overflow-hidden">
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center bg-black bg-opacity-20 text-white z-10">
              <h2 className="text-3xl text-[#eef0f4] font-semibold">Seat Booking</h2>
              <h3 className="text-xl text-[#eef0f4] font-semibold">Total seat: 101</h3>
              <h5 className="text-lg text-[#eef0f4] font-semibold">category: 5</h5>

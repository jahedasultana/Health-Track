...
const WhyChooseUs = () => {
    return (
        <div className="flex relative my-12 gap-12 items-center w-[90%] mx-auto">
            ...
            <div className="relative md:w-[50%] z-10 w-full">
                ...
                <div className="absolute inset-0 bg-black/20 z-10"></div> {/* Overlay */}
            </div>
            ...
            <div className="md:w-[50%] w-full text-[18px] font-semibold space-y-3 text-right"> {/* Align text right */}
                ...
                {/* content 1 */}
                <div className="flex w-full items-center gap-5 justify-start"> {/* Align icon and text to the right */}
